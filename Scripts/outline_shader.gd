...
const EXTRACTION_SHADER_PATH := "res://Shaders/extraction.gdshader"
const JF_PASS_SHADER_PATH := "res://Shaders/jf_pass.gdshader"
const OVERLAY_SHADER_PATH := "res://Shaders/overlay.gdshader"
